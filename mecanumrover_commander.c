        ...
        if (c!=-1) {
            ...
            if (c==27) {
                ...
                if ((c2==91)&&(c3==49)) {
                    ...
                    c5=getch();
                    c6=getch();
                    if ((c4==59)&&(c5==50)&&(c6==65)) { c=87; }
                    if ((c4==59)&&(c5==50)&&(c6==66)) { c=83; }
                    if ((c4==59)&&(c5==50)&&(c6==67)) { c=68; }
                    if ((c4==59)&&(c5==50)&&(c6==68)) { c=65; }
                    if ((c4==59)&&(c5==50)&&(c6==72)) { c=81; }
                }
                if ((c2==91)&&(c3==53)) {
                    c4=getch();
                    if (c4==126) { c=101; }
                    ...
                    if ((c4==59)&&(c5==50)&&(c6==126)) { c=69; }
                }
                if ((c2==91)&&(c3==65)) { c=119; }
                if ((c2==91)&&(c3==66)) { c=115; }
                if ((c2==91)&&(c3==67)) { c=100; }
                if ((c2==91)&&(c3==68)) { c= 97; }
                if ((c2==91)&&(c3==69)) { c= 32; }
                if ((c2==91)&&(c3==72)) { c=113; }

                timeout(500);
            }

            if ((c==119)||(c== 56)) { speedX+=25; }
            if (c== 87) { speedX+=100; }
            if ((c==115)||(c== 50)) { speedX-=25; }
            if (c== 83) { speedX-=100; }
            if ((c== 97)||(c== 52)) { speedY+=25; }
            if (c== 65) { speedY+=100; }
            if ((c==100)||(c== 54)) { speedY-=25; }
            if (c== 68) { speedY-=100; }
            if ((c==113)||(c== 55)) { rotate+=250; }
            if ((c==101)||(c== 57)) { rotate-=250; }
            if (c== 81) { rotate+=500; }
            if (c== 69) { rotate-=500; }
...
// pozitiv balra forgas (100 is meg eleg lassu)
    ...
    if (quit==2) { printf("Fatal error happened while reading memmap!\n"); }
    if (quit==3) { printf("Failed to read memmap correctly (invalid length)!\n"); }
    if (quit==4) { printf("Error while reading from socket()!\n"); }
    if (quit==5) { printf("Bad message received through socket - Too long (no newline found)!\n"); };
    if (quit==6) { printf("Could not reply to client! Connection was lost maybe?\n"); }
